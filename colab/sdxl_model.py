# ============================================================
# sdxl_model.py — Google Colab GPU server for Beaulix
# ============================================================
# IMPORTANT: This file is designed to be run as a Colab notebook cell,
# NOT imported as a Python module. All execution code is guarded by
# `if __name__ == "__main__"` to prevent accidental side-effects on import.
# To run: paste into a Colab cell or execute with: python sdxl_model.py
# ============================================================
